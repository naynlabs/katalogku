...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    if (result.error) {
      setAuthError(result.error.message || "Gagal mendaftar. Silakan coba lagi.");
      return;
    }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-container-lowest rounded-xl p-8 shadow-[0px_20px_40px_rgba(77,68,227,0.06)] relative overflow-hidden">
          ...
          <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="pt-2">
              <button type="submit" disabled={isSubmitting || isGoogleLoading} className="block w-full bg-gradient-to-br from-primary to-primary-container text-white font-bold py-4 rounded-full shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-transform text-center disabled:opacity-50 disabled:cursor-not-allowed">
