      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-on-surface-variant">
            Mulai jualan dalam hitungan menit. Tanpa biaya, tanpa ribet.
          </p>
        </div>
        ...
        <div className="bg-surface-container-lowest rounded-xl p-8 shadow-[0px_20px_40px_rgba(77,68,227,0.06)] relative overflow-hidden">
          ...
          <div className="flex bg-surface-container-low p-1 rounded-full mb-8">
            <Link href="/login" className="flex-1 py-2 text-sm font-semibold rounded-full text-on-surface-variant hover:text-on-surface transition-all text-center">
              Masuk
            </Link>
            <span className="flex-1 py-2 text-sm font-semibold rounded-full bg-white text-primary shadow-sm text-center">
              Daftar
            </span>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-2">
              ...
              <div className="relative">
                <input className="w-full bg-surface-container-low border-none rounded-lg px-4 py-3.5 text-on-surface placeholder:text-outline focus:ring-2 focus:ring-primary/40 transition-all outline-none" placeholder="Nama kamu" type="text" />
            ...
            <div className="pt-2">
              <Link href="/onboarding" className="block w-full bg-gradient-to-br from-primary to-primary-container text-white font-bold py-4 rounded-full shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-transform text-center">
                Daftar Sekarang
              </Link>
            </div>
          </form>
