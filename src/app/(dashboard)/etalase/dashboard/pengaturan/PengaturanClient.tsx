...
export default function PengaturanClient({ initialStore }: { initialStore: any }) {
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            <div>
              ...
              <p className="flex items-center gap-1.5 text-xs text-on-surface-variant mt-2 px-2">
                ...
                Mengubah nama tampilan di bio, tapi URL kamu tetap <span className="font-bold">katalogku.id/{initialStore.slug}</span>
              </p>
            </div>
