          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <section className="bg-surface-container-lowest rounded-2xl p-6 lg:p-8 border border-outline-variant/20 tonal-depth">
              ...
              <div className="space-y-4">
                <button className="w-full bg-surface-container py-3 rounded-full text-sm font-bold text-on-surface border-2 border-primary shadow-sm flex items-center justify-center gap-2">
                  Pill (Lengkungan Penuh) <span className="material-symbols-outlined text-[16px] text-primary">check_circle</span>
                </button>
                <button className="w-full bg-surface-container py-3 rounded-lg text-sm font-medium text-on-surface border-2 border-transparent hover:border-outline-variant transition-colors">
                  Rounded (Lengkung Halus)
                </button>
                <button className="w-full bg-surface-container py-3 text-sm font-medium text-on-surface border-2 border-transparent hover:border-outline-variant transition-colors">
                  Sharp (Sudut Tajam)
                </button>
              </div>
            </section>
